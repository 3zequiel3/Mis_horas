...
@token_required
def get_dias_mes(usuario_actual, proyecto_id, anio, mes):
...
@token_required
def get_dia(usuario_actual, dia_id):
...
@token_required
def update_horas(usuario_actual, dia_id):
    ...
    dia = DiaService.actualizar_horas_dia(dia_id, data['horas'], usuario_actual['id'])
...
@token_required
def update_horarios(usuario_actual, dia_id):
    ...
    dia = DiaService.actualizar_horarios_dia(dia_id, hora_entrada, hora_salida, usuario_actual['id'])
...
@token_required
def update_turnos(usuario_actual, dia_id):
